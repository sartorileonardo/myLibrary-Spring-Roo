...
import com.mylibrary.web.reports.ExportingErrorException;
import com.mylibrary.web.reports.JasperReportsCsvExporter;
import com.mylibrary.web.reports.JasperReportsExporter;
import com.mylibrary.web.reports.JasperReportsPdfExporter;
import com.mylibrary.web.reports.JasperReportsXlsExporter;
...
privileged aspect BooksCollectionThymeleafController_Roo_Thymeleaf {
     ...
     * 
     */
    private MethodLinkBuilderFactory<BooksCollectionThymeleafController> BooksCollectionThymeleafController.collectionLink;
     ...
     * @return MethodLinkBuilderFactory
     */
    public MethodLinkBuilderFactory<BooksCollectionThymeleafController> BooksCollectionThymeleafController.getCollectionLink() {
     ...
     */
    public void BooksCollectionThymeleafController.setCollectionLink(MethodLinkBuilderFactory<BooksCollectionThymeleafController> collectionLink) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<Book>> BooksCollectionThymeleafController.datatablesByIdsIn(@RequestParam("ids") List<Long> ids, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
     ...
     */
    @InitBinder("book")
    public void BooksCollectionThymeleafController.initBookBinder(WebDataBinder binder) {
    ...
    public void BooksCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            ...
            builder.addColumn(getMessageSource().getMessage("label_book_price", null, "Price", locale), "price", Float.class.getName(), 100);
        }
        else if (columnName.equals("publishingCompany")) {
            builder.addColumn(getMessageSource().getMessage("label_book_publishingcompany", null, "Publishing Company", locale), "publishingCompany", String.class.getName(), 100);
        }
