...
import com.mylibrary.web.BooksCollectionThymeleafLinkFactory;
...
privileged aspect BooksCollectionThymeleafLinkFactory_Roo_LinkFactory {
     ...
     * 
     */
    public static final String BooksCollectionThymeleafLinkFactory.DATATABLESBYIDSIN = "datatablesByIdsIn";
